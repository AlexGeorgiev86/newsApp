package com.sales.newsinshort.ui.components
...
@Composable
fun NewsRowComponent(article: Article, page: Int) {
    Column(
        modifier = Modifier
            .fillMaxSize()
            .padding(8.dp)
        ...
        AsyncImage(
            ...
            placeholder = painterResource(id = R.drawable.news_app_icon),
            error = painterResource(id = R.drawable.news_app_icon)
        )

        Spacer(modifier = Modifier.size(20.dp))

        HeadingTextComponent(textValue = article.title ?: "N/A")
...
fun AuthorDetailsComponent(authorName: String?, sourceName: String?) {
    Row(
        ...
        Text(text = authorName ?: "N/A")
        Spacer(modifier = Modifier.weight(1f))
        Text(text = sourceName ?: "N/A")
    }
}
...
fun EmptyStateComponent() {
    Column(
        ...
        HeadingTextComponent(textValue = "No news, check later!", true )
    }
}
...
fun NewsRowComponentPreview() {
    ...
    NewsRowComponent(article = article, page = 0)
}
